    ...
    public class SimpleHashTest
    {
        ...
        static void Main(string[] args)
        {
            ...
            string passwordHashMD5 =
                   SimpleHash.ComputeHash(password, SimpleHash.HashEnum.MD5, null);
            string passwordHashSha1 =
                   SimpleHash.ComputeHash(password, SimpleHash.HashEnum.SHA1, null);
            string passwordHashSha256 =
                   SimpleHash.ComputeHash(password, SimpleHash.HashEnum.SHA256, null);
            string passwordHashSha384 =
                   SimpleHash.ComputeHash(password, SimpleHash.HashEnum.SHA384, null);
            string passwordHashSha512 =
                   SimpleHash.ComputeHash(password, SimpleHash.HashEnum.SHA512, null);
